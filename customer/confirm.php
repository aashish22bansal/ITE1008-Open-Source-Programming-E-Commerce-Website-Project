                ...
                <div class="container"><!--container-->
                    ...
                    <div class="col-md-9">
                        <div class="box">
                            ...
                            <form action="Confirm.php?update_id=<?php echo $order_id ?>" method="post" enctype="multiple/form-data">
                            ...
                            <?php
                                if(isset($_POST['Confirm_Payment'])){
                                    ...
                                    $update_q = "update customer_order set order_status = '$complete' where invoice_no = '$invoice_number'";
