...
<?php
    ...
    if(isset($_GET['edit_product'])){
        ...
        $p_image3 = $row_edit['product_img2'];
...
<html>
    ...
    <head>
        ...
        <scrript src="//cdn.tinymce.com/4/tinymce.min.js"></script>
        <script>tinymce.init({selector:'textarea'});</script>
    </head>
    <body>
        <div class="row"><!--Row Starts-->
            <div class="col-lg-12"><!--col-lg-12 Starts-->
                <ol class="breadcrumb"><!-- Bread crumb starts-->
                    <li class="active">
                        <i class="fa fa-dashboard"></i>Dashboard/Edit Productss
                    </li>
            </div>
        </div>
        <div class="row">
                        ...
                        <div class="panel-body">
                            <form class="form-horizontal" method="post" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-6">
                                        <input type="text" name="product_keywords" class="form-control" required value="<?php echo $p_keyword?>">
                                    </div>
                                </div>
                                <div class="form-group">
