...
if(isset($_GET['pro_id'])){
    ...
    $gat_p_cat="select * from product_categories where p_cat_id='$p_cat_id'";
    $run_p_cat=mysqli_query($con,$gat_p_cat);
            ...
            <div class="container"><!--container-->
                <div class="col-md-12">
                    <ul class="breadcrumb">
                        ...
                        <li><a href="shop.php?p_cat=<?php echo "$p_cat_id";?>"><?php echo "$p_cat_title";?></li>
                ...
                <div class="col-md-9">
                    ...
                    <div id="row same-height-row"><!--row same-height-row STARTS-->
                        ...
                        while($row=mysqli_fetch_array($run_product)){
                            ...
                            <div class='text'>
                            <h3><a href='details.php?pro_id=$pro_id'></h3></div>
